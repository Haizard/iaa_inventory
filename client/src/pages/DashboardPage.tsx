...
import { Package, ShoppingCart, TrendingUp, Users, AlertTriangle, ShieldCheck, ArrowUpRight } from 'lucide-react';
      ...
      {dashboardLevel === 'limited' && (
        <>
          <div className="grid gap-4 md:grid-cols-2">
            {[
              { title: 'Record Sales', desc: 'As staff, you can record sales transactions for customers.', accentClass: 'glass-blue', iconBg: 'bg-blue-500/20', iconColor: 'text-blue-400', icon: TrendingUp,
              ...
              <div key={c.title} className={cn('glass rounded-2xl p-5 hover-lift', c.accentClass)}>
                <div className="flex items-center gap-3 mb-3">
                  <div className={cn('h-9 w-9 rounded-xl flex items-center justify-center', c.iconBg)}>
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ...
              { label: 'Low Stock Items', value: stats?.lowStockProducts?.length ?? 0,   icon: AlertTriangle, glassClass: 'glass-amber',  iconBg: 'bg-amber-500/20',  iconColor: 'text-amber-400' },
        ...
        <>
          ...
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              { title: 'Total Revenue',    value: formatCurrency(stats?.totalSalesAmount ?? 0),                  sub: `${stats?.totalSalesCount ?? 0} transactions`,   icon: TrendingUp,    glassClass: 'glass-emerald',iconBg: 'bg-emerald-500/20',iconColor: 'text-emerald-300' },
              ...(canViewPurchases ? [
          ...
          <div className="grid gap-4 md:grid-cols-2">
            {[
              { title: 'Recent Sales', data: stats?.recentSales, color: 'text-emerald-400', dotBg: 'bg-emerald-400', icon: TrendingUp, glassClass: 'glass-emerald',
